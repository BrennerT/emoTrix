...
\textbf{MUSS BEARBEITET WERDEN, der Sensor funktioniert anders als gedacht}
Wenn die Messung gestartet wurde, erhält die mobile Applikation  also alle 50 Millisekunden vom Arduino per Bluetooth einen Integer-Wert, der dem Widerstand auf der Haut des Nutzer entspricht. \newline
