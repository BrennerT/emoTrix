...
\subsection{Biometrische Erfassungsmöglichkeiten eines Smartphones}
Besitzer eines Smartphones haben dieses häufig rund um die Uhr bei sich. Das ermöglicht eine Datenerfassung, die theoretisch rund um die Uhr stattfinden kann. Welche Möglichkeiten ein Smartphone zur Datenerfassung bietet, soll in den folgenden Abschnitten genauer geklärt werden. 
